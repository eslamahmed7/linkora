    ...
    if (design.glassmorphism) {
      ...
      switch (design.linkStyle) {
        case 'outline':
          ...
          break
        case 'soft':
          style.backgroundColor = `${linkBgColor}1A` // 10% opacity hex
          style.border = 'none'
          style.color = linkBgColor
          break
        case '3d':
        ...
        case 'neon-border':
          ...
          break
        case 'glass-frost':
          style.backgroundColor = `${linkBgColor}33` // 20% opacity
          style.backdropFilter = 'blur(16px)'
          style.WebkitBackdropFilter = 'blur(16px)'
          style.border = `1px solid ${linkBgColor}4D` // 30% opacity
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center px-6 py-12 min-h-full">
            ...
            {design.profileImageUrl ? (
              <div
                className="mb-6 overflow-hidden border-2 border-white/20 shadow-lg"
                style={{
                  borderRadius: `${design.profileBorderRadius}%`,
              ...
              >
                <img src={design.profileImageUrl} alt={settings.title} className="w-full h-full object-cover" />
              </div>
            ) : (
              <div
                className="mb-6 bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center text-3xl font-bold text-neutral-400"
                style={{
                  borderRadius: `${design.profileBorderRadius}%`,
                  width: design.profileImageSize === 'small' ? '60px' : design.profileImageSize === 'medium' ? '80px' : '110px',
                  height: design.profileImageSize === 'small' ? '60px' : design.profileImageSize === 'medium' ? '80px' : '110px',
            ...
            <h1
              ...
              style={{
                ...
                fontSize: `${Math.min(design.headingSize, 32)}px`,
