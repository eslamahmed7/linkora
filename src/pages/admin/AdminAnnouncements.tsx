  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-neutral-900 dark:text-white tracking-tight">Announcements</h1>
          <p className="text-sm text-neutral-500 mt-0.5">{announcements.length} total announcements</p>
        </div>
        <button
          onClick={openCreate}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-neutral-100 dark:border-neutral-800">
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500">Title</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500 hidden md:table-cell">Content</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500">Type</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500 hidden lg:table-cell">Target</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500 hidden lg:table-cell">Channel</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500">Active</th>
                <th className="text-left px-5 py-3 text-[11px] font-bold uppercase tracking-wider text-neutral-500 hidden md:table-cell">Date</th>
            ...
            <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
              {isLoading ? (
                ...
                <tr><td colSpan={8} className="px-5 py-12 text-center text-sm text-neutral-400">No announcements yet</td></tr>
              ) : announcements.map(a => {
                      ...
                      <div className="flex items-center justify-end gap-1">
                        ...
                        {deleteConfirm === a.id ? (
                          <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                            <button onClick={() => handleDelete(a.id)} className="px-2 py-1 rounded-lg bg-red-600 text-white text-[10px] font-bold hover:bg-red-700">Yes</button>
                            <button onClick={() => setDeleteConfirm(null)} className="px-2 py-1 rounded-lg bg-neutral-200 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-400 text-[10px] font-bold hover:bg-neutral-300 dark:hover:bg-neutral-600">No</button>
                          </div>
                        ) : (
                          <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 w-full max-w-lg shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-100 dark:border-neutral-800">
              <h2 className="font-bold text-neutral-900 dark:text-white">{editing ? 'Edit Announcement' : 'New Announcement'}</h2>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider">Target</label>
                  <select
                    value={form.target}
              ...
              <div>
                <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider">Channel</label>
                <select
                  value={form.channel}
              ...
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider">Active</label>
                <button
                  type="button"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider">Starts At</label>
                  <input
                    type="datetime-local"
                ...
                <div>
                  <label className="text-xs font-bold text-neutral-500 uppercase tracking-wider">Expires At</label>
                  <input
                    type="datetime-local"
